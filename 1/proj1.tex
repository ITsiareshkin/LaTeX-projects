...
\begin{document}
    ...
    \section{Smíšená sazba}\label{smisena}  
        ...
        \begin{quotation}
            Čím více \texttt{druhů}, \textit{řezů}, {\tiny velikostí}, \textcolor{green}{barev} písma a \textcolor{blue}{\textsc{jiných efektů}} \underline{použijeme}, \textcolor{red}{tím profesionálněji} bude {\fontfamily{pzc}\selectfont{dokument}} vypadat. Čtenář tím bude \textbf{\Huge{vždy nadšen!}}
        \end{quotation}
